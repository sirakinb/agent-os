    ...
    <main className="min-h-screen bg-neutral-950 text-white selection:bg-indigo-500/30 flex">
      ...
      <div className={cn("flex-1 p-8 transition-all duration-300", isSidebarOpen ? "ml-64" : "ml-0")}>
        <div className="max-w-5xl mx-auto">
          ...
          {/* TikTok Enhance View */}
          <div className={currentView === "tiktok" ? "block" : "hidden"}>
            <TikTokEnhance />
          </div>

          {/* Transcription View */}
          <div className={currentView === "transcription" ? "block" : "hidden"}>
            <Transcription />
          </div>

          {/* Connect Socials View */}
          <div className={currentView === "connect" ? "block" : "hidden"}>
            <ConnectSocials />
          </div>

          {/* Schedule Post View */}
          <div className={currentView === "schedule" ? "block" : "hidden"}>
            <SchedulePost />
          </div>

          {/* Content Calendar View */}
          <div className={currentView === "calendar" ? "block" : "hidden"}>
            <ContentCalendar />
          </div>

          {/* YouTube Assets View (Default) */}
          <div className={currentView === "youtube" ? "block" : "hidden"}>
            <motion.div
